...
import Tools.ISymetricDifferencer;
import Tools.Set;
...
@CommandLine.Command(name = "symmetric-difference", description = "Calculates the difference of provided sets.")
public class SymetricDifferenceCommand implements Callable<Integer>
{

    private final ISymetricDifferencer symetricDifferencer;
    @CommandLine.Spec
    ...
    @Inject
    public SymetricDifferenceCommand(ISymetricDifferencer symetricDifferencer)
    {
        this.symetricDifferencer = symetricDifferencer;
    }
    ...
    public Integer call() throws Exception
    {
        ...
        Set result = symetricDifferencer.calculate(set1, set2);
